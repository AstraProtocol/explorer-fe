		...
		<Col>
			...
			<Row className="md-flex-column">
				<LineChart
					...
					rightTitle={{
						title: 'Daily Average',
						value: parseFloat(ethers.utils.formatEther(`${feeDailyRes?.result?.dailyAverage || 0}`))
					}}
					data={feeDailyData}
				...
				<BarChart
					...
					rightTitle={{
						...
						value: parseFloat(ethers.utils.formatEther(`${feeMonthRes?.result?.monthlyAverage || 0}`))
					}}
					data={feeMonthData}
